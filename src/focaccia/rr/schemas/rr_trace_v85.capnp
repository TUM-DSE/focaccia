...
# Packaged from rr commit 7fe1e367c2b4e0df7647e020c20d66827badfad3
# for trace version 85. See RR-LICENSE in this package.

@0xcaa0b1486c12c629;

# The upstream C++ namespace annotation is omitted from this packaged reader
# copy so pycapnp does not depend on a system Cap'n Proto include directory.
# It does not affect the schema ID or wire format.
